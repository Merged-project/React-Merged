    ...
    return (
        <section className='artistList'>
            ...
            <div className='container'>
                <img className='bandPic' src="https://images.pexels.com/photos/1763075/pexels-photo-1763075.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
                <div className='artistInfo'>
                    <p id="artistName">Artist Name</p>
                    <p className='datetime'>00/00/00</p>
